...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("frynogs", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("frynogs", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "frynogs";
		app.meta["name"] = "Frynogs Engine";
		app.meta["packageName"] = "com.manfire100.frynogs";
